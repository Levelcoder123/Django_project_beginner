...
urlpatterns = [
    ...
    path('accounts/', views.AccountListCreateAPIView.as_view(), name='account-list-create_api'),
    path('account/<int:pk>/', views.AccountRetrieveUpdateDestroyAPIView.as_view(), name='account-RUD_api'),
]
